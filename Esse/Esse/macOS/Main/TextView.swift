//Taken and refactored from https://github.com/krzyzanowskim/STTextView/blob/main/Sources/STTextViewUI/TextView.swift
...
private struct TextViewRepresentable: NSViewRepresentable {
    ...
    private func setupLineNumberView(_ scrollView: NSScrollView, _ textView: STTextView) {
        let rulerView = STLineNumberRulerView(textView: textView)
        rulerView.font = .monospacedDigitSystemFont(ofSize: 12, weight: .regular)
...
//    var plugins: [any STPlugin]  // New parameter for plugins
//
//    func makeNSView(context: Context) -> NSScrollView {
//        let scrollView = STTextView.scrollableTextView()
//        let textView = scrollView.documentView as! STTextView
...
//
//        if textView.attributedString() != NSAttributedString(text) {
//            textView.setAttributedString(NSAttributedString(text))
//        }
//
//        // Update plugins if needed
//        updatePlugins(textView)
//    }
//
...
//    }
//
//    private func setupTextView(_ textView: STTextView) {
...
//    }
//
//    private func updatePlugins(_ textView: STTextView) {
//        // Add new plugins
//        for plugin in plugins {
//            textView.addPlugin(plugin)
//        }
...
//        var parent: STTextViewWrapper
//
//        init(_ parent: STTextViewWrapper) {
//            self.parent = parent
//        }
//
